...
/**
 * Двунаправленная интеграция OpenQASM 2.0.
 */
public final class OpenQasm2Integration implements QuantumIntegration {

    /**
     * Exporter OpenQASM 2.0.
     */
    private final OpenQasm2Exporter exporter;

    /**
     * Importer OpenQASM 2.0.
     */
    private final OpenQasm2Importer importer;

    /**
     * Создает OpenQASM 2.0 integration adapter.
     */
    public OpenQasm2Integration() {
        this.exporter = new OpenQasm2Exporter();
        this.importer = new OpenQasm2Importer();
    }

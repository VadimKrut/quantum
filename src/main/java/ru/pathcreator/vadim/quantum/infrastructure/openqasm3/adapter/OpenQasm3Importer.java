...
import ru.pathcreator.vadim.quantum.infrastructure.openqasm3.include.OpenQasm3IncludeResolver;
import ru.pathcreator.vadim.quantum.infrastructure.openqasm3.include.OpenQasm3IncludeResolverResult;
import ru.pathcreator.vadim.quantum.infrastructure.openqasm3.syntax.OpenQasm3Parser;
import ru.pathcreator.vadim.quantum.infrastructure.openqasm3.syntax.OpenQasm3ParserResult;

/**
 * Importer OpenQASM 3.0 в Quantum IR.
 */
public final class OpenQasm3Importer implements QuantumImporter {

    /**
     * Parser OpenQASM 3.0.
     */
    private final OpenQasm3Parser parser;
    ...
    /**
     * Создает importer OpenQASM 3.0.
     */
    public OpenQasm3Importer() {
        this.parser = new OpenQasm3Parser();
        this.validator = new QuantumProgramValidator();
        this.includeResolver = new OpenQasm3IncludeResolver();
    }
    ...
    public ImportResult importProgram(
        ...
        final OpenQasm3IncludeResolverResult resolverResult = includeResolver.resolve(options);
        ...
        final OpenQasm3ParserResult parserResult = parser.parse(
            source,

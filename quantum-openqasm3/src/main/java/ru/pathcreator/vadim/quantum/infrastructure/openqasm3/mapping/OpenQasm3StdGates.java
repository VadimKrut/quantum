...
/**
 * Реестр gate из стандартной библиотеки OpenQASM 3.
 */
public final class OpenQasm3StdGates {
    ...
    private OpenQasm3StdGates() {
        throw new UnsupportedOperationException("Utility class must not be instantiated.");
    }

    /**
     * Возвращает gate из стандартной библиотеки по имени OpenQASM 3.
     *
     ...
     *
     * @param name имя gate во внешнем формате
     * @return true, если имя занято стандартной библиотекой
     */
    ...
    /**
     * Проверяет, является ли gate adapter-level intrinsic из стандартной библиотеки.
     *
     * @param gate gate Quantum IR
     * @return true, если gate совпадает со стандартным intrinsic
     */
    public static boolean isStdGate(final Gate gate) {
        if (gate == null) {
            throw new IllegalArgumentException("Gate must not be null.");
        }
        final Gate standardGate = byName(gate.gateName());
        return standardGate != null
